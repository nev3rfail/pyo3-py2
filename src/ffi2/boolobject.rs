...
pub unsafe fn PyBool_Check(op: *mut PyObject) -> c_int { unsafe {
    let u: *mut PyTypeObject = &raw mut PyBool_Type;
    (Py_TYPE(op) == u) as c_int
}}

#[inline]
pub unsafe fn Py_False() -> *mut PyObject { unsafe {
    &raw mut _Py_ZeroStruct as *mut PyBoolObject as *mut PyObject
}}

#[inline]
pub unsafe fn Py_True() -> *mut PyObject { unsafe {
    &raw mut _Py_TrueStruct as *mut PyBoolObject as *mut PyObject
}}
